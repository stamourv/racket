...
(module stxcase '#%kernel
  (#%require (submod ".." stx) (submod ".." small-scheme) '#%paramz '#%unsafe
             (submod ".." ellipses)
             (for-syntax (submod ".." stx) (submod ".." small-scheme)
                         (submod ".." member) (submod ".." sc) '#%kernel))
  ...
  (#%provide (all-from (submod ".." ellipses)) syntax-case** syntax datum
