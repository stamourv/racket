...
(module stxcase-scheme '#%kernel
  (#%require (submod ".." small-scheme) (submod ".." stx) (submod ".." stxcase) (submod ".." with-stx) (submod ".." stxloc)
             (for-syntax '#%kernel (submod ".." small-scheme) (submod ".." stx) (submod ".." stxcase)
                         (submod ".." stxloc)))
  ...
  (#%provide syntax datum (all-from (submod ".." with-stx)) (all-from (submod ".." stxloc)) 
