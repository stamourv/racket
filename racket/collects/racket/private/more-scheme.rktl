...
(module more-scheme '#%kernel
  (#%require (submod ".." small-scheme) (submod ".." define) '#%paramz (submod ".." case) (submod ".." logger)
             (submod ".." member)
             (for-syntax '#%kernel (submod ".." stx) (submod ".." small-scheme) (submod ".." stxcase-scheme) (submod ".." qqstx)))
