...
(module case '#%kernel
  (#%require '#%paramz '#%unsafe (submod ".." small-scheme) (submod ".." define)
             (for-syntax '#%kernel (submod ".." small-scheme) (submod ".." stxcase-scheme)
                         (submod ".." qqstx) (submod ".." define) (submod ".." sort)))
  (#%provide case)
