...
(module pre-base '#%kernel
  (#%require (for-syntax '#%kernel
                         (submod ".." stx)
                         (submod ".." qq-and-or)))
  (#%require (submod ".." more-scheme)
             (submod ".." misc)
             (all-except (submod ".." define) define define-syntax define-for-syntax)
             (submod ".." letstx-scheme)
             (submod ".." kw)
             (submod ".." define-struct)
             (submod ".." reqprov)
             (prefix printing: (submod ".." modbeg))
             (submod ".." for)
             (submod ".." map) ; shadows #%kernel bindings
             (submod ".." member)
             (submod ".." kernstruct)
             (submod ".." norm-arity)
             (submod ".." top-int)
             '#%builtin  ; so it's attached
             (for-syntax (submod ".." kw)
                         (submod ".." norm-define)))
  ...
  (#%provide (all-from-except (submod ".." more-scheme) old-case fluid-let)
             (all-from-except (submod ".." misc) collection-path collection-file-path)
             (all-from (submod ".." define))
             (all-from-except (submod ".." letstx-scheme) -define -define-syntax -define-struct old-cond)
             ...
             (all-from (submod ".." reqprov))
             (all-from-except (submod ".." for)
                              ...
                              split-for-body)
             (all-from (submod ".." kernstruct))
             (all-from (submod ".." member))
             #%top-interaction
